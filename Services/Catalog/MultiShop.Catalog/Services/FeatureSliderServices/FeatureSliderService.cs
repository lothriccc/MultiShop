...
namespace MultiShop.Catalog.Services.FeatureSliderServices
{
    public class FeatureSliderService : IFeatureSliderService
    {
        ...
        public FeatureSliderService(IMapper mapper, IDatabaseSettings _databaseSettings)
        {
            ...
            _featureSliderCollection = database.GetCollection<FeatureSlider>(_databaseSettings.FeatureSliderCollectionImageName);
            _mapper = mapper;
        }
        ...
        public async Task DeleteFeatureSliderAync(string id)
        {
            await _featureSliderCollection.DeleteOneAsync(x => x.FeaturreSliderID == id);
        }
        ...
        {
            var values = await _featureSliderCollection.Find<FeatureSlider>(x => x.FeaturreSliderID == id).FirstOrDefaultAsync();
        ...
        public async Task UpdateFeatureSliderAsync(UpdateFeatureSliderDto updateFeatureSliderDto)
        {
            ...
            await _featureSliderCollection.FindOneAndReplaceAsync(x => x.FeaturreSliderID == updateFeatureSliderDto.FeaturreSliderID, values);
        }
    }
}
